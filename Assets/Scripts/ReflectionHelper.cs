...
public static class ReflectionHelper
{
    ...
    // added this one bc i needed it
    // - julie
    public static IEnumerable<PropertyInfo> GetAllProperties(this Type t, BindingFlags bindingFlags)
    {
        if (t == null)
        ...
        BindingFlags flags = bindingFlags |
                             BindingFlags.DeclaredOnly;
        return t.GetProperties(flags).Concat(GetAllProperties(t.BaseType, bindingFlags));
    }
